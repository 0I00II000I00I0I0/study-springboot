package com.liujie.study.springboot.jpa.repository.impl;
...
public class UserRepositoryImpl implements UserCustomRepository {
    ...
    public Page<User> search(UserSearchForm userSearchForm, Pageable pageable) {
        ...
        StringBuffer sqlBuffer = new StringBuffer("form User t where 1=1");
        ...
        List<User> content = totalSize > pageable.getOffset() ? dataQuery.getResultList() : Collections.emptyList();
